				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<div class="hp-banner jumbotron wht-border-bottom" style="background-image: url(<?php echo $banner_img; ?>)">
						...
						<a href="<?php echo get_permalink($dashboard_pg->ID ); ?>" class="btn btn-default btn-block btn-lg"><?php echo get_the_title($dashboard_pg->ID); ?> <i class="fa fa-dashboard pull-right"></i></a>
							...
							<div class="col-xs-4">
						<a href="<?php echo get_permalink($your_claim_pg->ID ); ?>" class="btn btn-default btn-block btn-lg"><?php echo get_the_title($your_claim_pg->ID); ?> <i class="fa fa-folder-open pull-right"></i></a>
							</div>
							<div class="col-xs-4">
						...
						<a href="<?php echo get_permalink($cases_pg); ?>" class="btn btn-default btn-block btn-lg"><?php echo get_the_title($cases_pg); ?><i class="fa fa-folder-open pull-right"></i></a>
							...
							<div class="col-xs-4">
						<a href="<?php echo get_permalink($clients_pg->ID ); ?>" class="btn btn-default btn-block btn-lg"><?php echo get_the_title($clients_pg->ID); ?> <i class="fa fa-users pull-right"></i></a>
							</div>
							<div class="col-xs-4">
								<a href="<?php echo get_permalink($referrers_pg->ID ); ?>" class="btn btn-default btn-block btn-lg"><?php echo get_the_title($referrers_pg->ID); ?> <i class="fa fa-building pull-right"></i></a>
							</div>
						</div>
						</div>		
						<?php } ?>
